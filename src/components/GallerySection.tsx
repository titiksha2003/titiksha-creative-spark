  ...
  const galleryItems = [
    {
      ...
      category: "posters",
      type: "poster",
      description: "Designed for NGO awareness campaign",
    ...
    {
      id: 4,
      title: "Event Promotional Material",
      category: "posters",
      type: "poster", 
      description: "College fest promotional design",
    ...
    },
    {
      ...
      category: "thumbnails",
      type: "thumbnail",
      description: "Programming tutorial thumbnail",
      tools: ["Canva", "Figma"]
    },
    {
      id: 6,
